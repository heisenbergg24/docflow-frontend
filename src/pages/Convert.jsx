  ...
  const handleConversionSelect = async (option) => {
    ...
    try {
      ...
      if (isPdfToImage) {
        ...
        const res = await fetch('http://localhost:8080/api/convert/pdf-to-image', {
          method: 'POST',
          body: formData
        })
        ...
        const res = await fetch('http://localhost:8080/api/convert/image-to-pdf', {
          method: 'POST',
          body: formData
        })
        ...
        const res = await fetch('http://localhost:8080/api/convert/pdf-to-word', {
          method: 'POST',
          body: formData
        })
        ...
        const res = await fetch('http://localhost:8080/api/convert/pdf-to-ppt', {
          method: 'POST',
          body: formData
        })
        ...
        const res = await fetch('http://localhost:8080/api/convert/office-to-pdf', {
          method: 'POST',
          body: formData
        })
